<template>
  <div id="main" :class="isDay ? 'day' : 'night'">
    <div class="container my-5" style="max-width: 400px; min-width: 360px">
      <h1 class="title text-center">Previsão do Tempo</h1>
      ...
      <!-- if you don't correctly type the name of the city or country the message of city not found will be displayed  -->
          ...
          <div class="card-mid">
            ...
            <div class="row">
              <div class="col d-flex justify-content-between px-5 mx-5">
                <p>
                  <img src="./assets/imagens/down.svg" alt="" />
                  {{ weather.lowTemp }}&deg;C
                </p>
                <p>
                  <img src="./assets/imagens/up.svg" alt="" />
...
export default {
  ...
  methods: {
    getWeather: async function () {
      ...
      const baseURL = `http://api.openweathermap.org/data/2.5/weather?q=${this.citySearch}&appid=${key}&units=metric&lang=pt_br`;
